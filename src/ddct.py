...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--codes", nargs="*", default=[],
    ...
    parser.add_argument("-u", "--use-plugins", nargs="*", default=[],
    ...
    parser.add_argument("-t", "--tags", nargs="*", default=[],
                        help="Accepts a space separated list of tags.  "
                             ...
                             "the tag")
    parser.add_argument("-n", "--not-tags", nargs="*", default=[],
                        help="Accepts as space separated list of tags.  "
                             "These tags are used to deselect checks matching "
                             "the tag, this takes precedence over '--tags'")
    parser.add_argument("-b", "--print-tags", action="store_true",
                        help="Print available tags.  Only prints tags for "
                             "plugins loaded with '-u' as well as generally "
                             "available tags")
